import fs from 'fs';
import type { ResponseLike } from 'octogen-api/internal/to-file';
import { toFile } from 'octogen-api/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('octogen-api/core/uploads');
    await expect(
